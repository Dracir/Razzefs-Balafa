...
namespace Magicolo {
	public static class TransformExtensions {
		...
		#region Position
		public static void SetPosition(this Transform transform, Vector3 position, Axes axis = Axes.XYZ) {
			transform.position = transform.position.SetValues(position, axis);
		}
		
		public static void SetPosition(this Transform transform, float position, Axes axis = Axes.XYZ) {
			transform.SetPosition(new Vector3(position, position, position), axis);
		}
		
		public static void Translate(this Transform transform, Vector3 translation, Axes axis = Axes.XYZ) {
			transform.SetPosition(transform.position + translation * Time.deltaTime, axis);
		}
		
		public static void Translate(this Transform transform, float translation, Axes axis = Axes.XYZ) {
			transform.Translate(new Vector3(translation, translation, translation), axis);
		}
		
		public static void TranslateTowards(this Transform transform, Vector3 targetPosition, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
		...
		public static void TranslateTowards(this Transform transform, Vector3 targetPosition, float speed, Axes axis = Axes.XYZ) {
			transform.TranslateTowards(targetPosition, speed, InterpolationModes.Quadratic, axis);
		}
		
		public static void TranslateTowards(this Transform transform, float targetPosition, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			transform.TranslateTowards(new Vector3(targetPosition, targetPosition, targetPosition), speed, interpolation, axis);
		}
		
		public static void TranslateTowards(this Transform transform, float targetPosition, float speed, Axes axis = Axes.XYZ) {
		...
		public static void OscillatePosition(this Transform transform, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axis = Axes.XYZ) {
			transform.SetPosition(transform.position.Oscillate(frequency, amplitude, center, transform.GetInstanceID() / 1000, axis), axis);
		}
		
		public static void OscillatePosition(this Transform transform, Vector3 frequency, Vector3 amplitude, Axes axis = Axes.XYZ) {
			transform.OscillatePosition(frequency, amplitude, Vector3.zero, axis);
		}

		public static void OscillatePosition(this Transform transform, float frequency, float amplitude, float center, Axes axis = Axes.XYZ) {
		...
		public static void OscillatePosition(this Transform transform, float frequency, float amplitude, Axes axis = Axes.XYZ) {
		...
		public static void SetLocalPosition(this Transform transform, Vector3 position, Axes axis = Axes.XYZ) {
			transform.localPosition = transform.localPosition.SetValues(position, axis);
		}
		
		public static void SetLocalPosition(this Transform transform, float position, Axes axis = Axes.XYZ) {
			transform.SetLocalPosition(new Vector3(position, position, position), axis);
		}
		
		public static void TranslateLocal(this Transform transform, Vector3 translation, Axes axis = Axes.XYZ) {
			transform.SetLocalPosition(transform.localPosition + translation * Time.deltaTime, axis);
		}
		
		public static void TranslateLocal(this Transform transform, float translation, Axes axis = Axes.XYZ) {
			transform.TranslateLocal(new Vector3(translation, translation, translation), axis);
		}
		
		public static void TranslateLocalTowards(this Transform transform, Vector3 targetPosition, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			switch (interpolation) {
				case InterpolationModes.Quadratic:
		...
		public static void TranslateLocalTowards(this Transform transform, Vector3 targetPosition, float speed, Axes axis = Axes.XYZ) {
			transform.TranslateLocalTowards(targetPosition, speed, InterpolationModes.Quadratic, axis);
		}
		
		public static void TranslateLocalTowards(this Transform transform, float targetPosition, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			transform.TranslateLocalTowards(new Vector3(targetPosition, targetPosition, targetPosition), speed, interpolation, axis);
		}
		
		public static void TranslateLocalTowards(this Transform transform, float targetPosition, float speed, Axes axis = Axes.XYZ) {
		...
		public static void OscillateLocalPosition(this Transform transform, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateLocalPosition(this Transform transform, Vector3 frequency, Vector3 amplitude, Axes axis = Axes.XYZ) {
			transform.OscillateLocalPosition(frequency, amplitude, Vector3.zero, axis);
		}

		public static void OscillateLocalPosition(this Transform transform, float frequency, float amplitude, float center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateLocalPosition(this Transform transform, float frequency, float amplitude, Axes axis = Axes.XYZ) {
		...
		#region Rotation
		public static void SetEulerAngles(this Transform transform, Vector3 angles, Axes axis = Axes.XYZ) {
			transform.eulerAngles = transform.eulerAngles.SetValues(angles, axis);
		}
		
		public static void SetEulerAngles(this Transform transform, float angle, Axes axis = Axes.XYZ) {
			transform.SetEulerAngles(new Vector3(angle, angle, angle), axis);
		}
		
		public static void Rotate(this Transform transform, Vector3 rotation, Axes axis = Axes.XYZ) {
			transform.SetEulerAngles(transform.eulerAngles + rotation * Time.deltaTime, axis);
		}
		
		public static void Rotate(this Transform transform, float rotation, Axes axis = Axes.XYZ) {
			transform.Rotate(new Vector3(rotation, rotation, rotation), axis);
		}
			
		public static void RotateTowards(this Transform transform, Vector3 targetAngles, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			switch (interpolation) {
				case InterpolationModes.Quadratic:
		...
		public static void RotateTowards(this Transform transform, Vector3 targetAngles, float speed, Axes axis = Axes.XYZ) {
			transform.RotateTowards(targetAngles, speed, InterpolationModes.Quadratic, axis);
		}
		
		public static void RotateTowards(this Transform transform, float targetAngle, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			transform.RotateTowards(new Vector3(targetAngle, targetAngle, targetAngle), speed, interpolation, axis);
		}
		
		public static void RotateTowards(this Transform transform, float targetAngle, float speed, Axes axis = Axes.XYZ) {
			transform.RotateTowards(new Vector3(targetAngle, targetAngle, targetAngle), speed, InterpolationModes.Quadratic, axis);
		}

		public static void OscillateEulerAngles(this Transform transform, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateEulerAngles(this Transform transform, Vector3 frequency, Vector3 amplitude, Axes axis = Axes.XYZ) {
			transform.OscillateEulerAngles(frequency, amplitude, Vector3.zero, axis);
		}

		public static void OscillateEulerAngles(this Transform transform, float frequency, float amplitude, float center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateEulerAngles(this Transform transform, float frequency, float amplitude, Axes axis = Axes.XYZ) {
		...
		public static void SetLocalEulerAngles(this Transform transform, Vector3 angles, Axes axis = Axes.XYZ) {
			transform.localEulerAngles = transform.localEulerAngles.SetValues(angles, axis);
		}
		
		public static void SetLocalEulerAngles(this Transform transform, float angle, Axes axis = Axes.XYZ) {
			transform.SetLocalEulerAngles(new Vector3(angle, angle, angle), axis);
		}
		
		public static void RotateLocal(this Transform transform, Vector3 rotation, Axes axis = Axes.XYZ) {
			transform.SetLocalEulerAngles(transform.localEulerAngles + rotation * Time.deltaTime, axis);
		}
		
		public static void RotateLocal(this Transform transform, float rotation, Axes axis = Axes.XYZ) {
			transform.RotateLocal(new Vector3(rotation, rotation, rotation), axis);
		}
			
		public static void RotateLocalTowards(this Transform transform, Vector3 targetAngles, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			switch (interpolation) {
				case InterpolationModes.Quadratic:
		...
		public static void RotateLocalTowards(this Transform transform, Vector3 targetAngles, float speed, Axes axis = Axes.XYZ) {
			transform.RotateLocalTowards(targetAngles, speed, InterpolationModes.Quadratic, axis);
		}
		
		public static void RotateLocalTowards(this Transform transform, float targetAngle, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			transform.RotateLocalTowards(new Vector3(targetAngle, targetAngle, targetAngle), speed, interpolation, axis);
		}
		
		public static void RotateLocalTowards(this Transform transform, float targetAngle, float speed, Axes axis = Axes.XYZ) {
			transform.RotateLocalTowards(new Vector3(targetAngle, targetAngle, targetAngle), speed, InterpolationModes.Quadratic, axis);
		}

		public static void OscillateLocalEulerAngles(this Transform transform, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateLocalEulerAngles(this Transform transform, Vector3 frequency, Vector3 amplitude, Axes axis = Axes.XYZ) {
			transform.OscillateLocalEulerAngles(frequency, amplitude, Vector3.one, axis);
		}

		public static void OscillateLocalEulerAngles(this Transform transform, float frequency, float amplitude, float center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateLocalEulerAngles(this Transform transform, float frequency, float amplitude, Axes axis = Axes.XYZ) {
		...
		#region Scale
		public static void SetScale(this Transform transform, Vector3 scale, Axes axis = Axes.XYZ) {
		...
		public static void SetScale(this Transform transform, float scale, Axes axis = Axes.XYZ) {
			transform.SetScale(new Vector3(scale, scale, scale), axis);
		}
		
		public static void Scale(this Transform transform, Vector3 scale, Axes axis = Axes.XYZ) {
			transform.SetScale(transform.localScale + scale, axis);
		}
		
		public static void Scale(this Transform transform, float scale, Axes axis = Axes.XYZ) {
			transform.SetScale(new Vector3(scale, scale, scale), axis);
		}
	
		public static void ScaleTowards(this Transform transform, Vector3 targetScale, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			switch (interpolation) {
				case InterpolationModes.Quadratic:
		...
		public static void ScaleTowards(this Transform transform, Vector3 targetScale, float speed, Axes axis = Axes.XYZ) {
			transform.ScaleTowards(targetScale, speed, InterpolationModes.Quadratic, axis);
		}
		
		public static void ScaleTowards(this Transform transform, float targetScale, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			transform.ScaleTowards(new Vector3(targetScale, targetScale, targetScale), speed, interpolation, axis);
		}
		
		public static void ScaleTowards(this Transform transform, float targetScale, float speed, Axes axis = Axes.XYZ) {
			transform.ScaleTowards(new Vector3(targetScale, targetScale, targetScale), speed, InterpolationModes.Quadratic, axis);
		}

		public static void OscillateScale(this Transform transform, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axis = Axes.XYZ) {
			transform.SetScale(transform.lossyScale.Oscillate(frequency, amplitude, center, transform.GetInstanceID() / 1000, axis), axis);
		}
		
		public static void OscillateScale(this Transform transform, Vector3 frequency, Vector3 amplitude, Axes axis = Axes.XYZ) {
			transform.OscillateScale(frequency, amplitude, Vector3.one, axis);
		}

		public static void OscillateScale(this Transform transform, float frequency, float amplitude, float center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateScale(this Transform transform, float frequency, float amplitude, Axes axis = Axes.XYZ) {
		...
		public static void FlipScale(this Transform transform, Axes axis = Axes.XYZ) {
			transform.SetScale(transform.lossyScale.SetValues(-transform.lossyScale, axis), axis);
		}
		
		public static void SetLocalScale(this Transform transform, Vector3 scale, Axes axis = Axes.XYZ) {
			transform.localScale = transform.localScale.SetValues(scale, axis);
		}
		
		public static void SetLocalScale(this Transform transform, float scale, Axes axis = Axes.XYZ) {
			transform.SetLocalScale(new Vector3(scale, scale, scale), axis);
		}
		
		public static void ScaleLocal(this Transform transform, Vector3 scale, Axes axis = Axes.XYZ) {
			transform.SetLocalScale(transform.localScale + scale, axis);
		}
		
		public static void ScaleLocal(this Transform transform, float scale, Axes axis = Axes.XYZ) {
			transform.ScaleLocal(new Vector3(scale, scale, scale), axis);
		}
			
		public static void ScaleLocalTowards(this Transform transform, Vector3 targetScale, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			switch (interpolation) {
				case InterpolationModes.Quadratic:
		...
		public static void ScaleLocalTowards(this Transform transform, Vector3 targetScale, float speed, Axes axis = Axes.XYZ) {
			transform.ScaleLocalTowards(targetScale, speed, InterpolationModes.Quadratic, axis);
		}
		
		public static void ScaleLocalTowards(this Transform transform, float targetScale, float speed, InterpolationModes interpolation, Axes axis = Axes.XYZ) {
			transform.ScaleLocalTowards(new Vector3(targetScale, targetScale, targetScale), speed, interpolation, axis);
		}
		
		public static void ScaleLocalTowards(this Transform transform, float targetScale, float speed, Axes axis = Axes.XYZ) {
			transform.ScaleLocalTowards(new Vector3(targetScale, targetScale, targetScale), speed, InterpolationModes.Quadratic, axis);
		}

		public static void OscillateLocalScale(this Transform transform, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axis = Axes.XYZ) {
			transform.SetLocalScale(transform.localScale.Oscillate(frequency, amplitude, center, transform.GetInstanceID() / 1000, axis), axis);
		}
		
		public static void OscillateLocalScale(this Transform transform, Vector3 frequency, Vector3 amplitude, Axes axis = Axes.XYZ) {
			transform.OscillateLocalScale(frequency, amplitude, Vector3.one, axis);
		}

		public static void OscillateLocalScale(this Transform transform, float frequency, float amplitude, float center, Axes axis = Axes.XYZ) {
		...
		public static void OscillateLocalScale(this Transform transform, float frequency, float amplitude, Axes axis = Axes.XYZ) {
		...
		public static void FlipLocalScale(this Transform transform, Axes axis = Axes.XYZ) {
